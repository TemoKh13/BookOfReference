...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookOfReference.API.DTO.PersonWithRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookOfReference.API.Models.RelatedPerson", b =>
                {
                    ...
                    b.Property<int?>("PersonWithRelationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PersonWithRelationId");
            ...
            modelBuilder.Entity("BookOfReference.API.Models.RelatedPerson", b =>
                {
                    b.HasOne("BookOfReference.API.Models.Person", "person")
                        .WithMany("RelatedPeople")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookOfReference.API.DTO.PersonWithRelation", null)
                        .WithMany("RelatedPeople")
                        .HasForeignKey("PersonWithRelationId");
